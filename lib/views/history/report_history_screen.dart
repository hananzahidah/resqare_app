...
class _ReportHistoryScreenState extends State<ReportHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    // Filter reports based on status & query using _matchStatus helper
    ...
    final totalReports = _userReports.length;
    final activeReports = _userReports.where((r) {
    ...
    final finishedReports = _userReports.where((r) {
      final st = r.status.toLowerCase();
  ...
  Widget _buildStatsHeader(int total, int active, int finished) {
    return Container(
  ...
  Widget _buildHistoryCard(ReportModel report) {
    ...
    final isUrgent =
        ...
        report.priorityLevel.toLowerCase() == 'emergency';
